The default Peppy player resolution is 480*320 pixels. This is the resolution of the touchscreen used for the project. It's defined in the configuration file ```config.txt```:
```
[screen.info]
width = 480
height = 320
